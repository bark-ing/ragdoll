...
--[=[
	Automatically applies ragdoll upon attribute "Ragdoll".
	@prop RagdollHumanoidOnAttribute PlayerHumanoidBinder<RagdollHumanoidOnAttribute>
	@within RagdollBindersServer
]=]
	self:Add(PlayerHumanoidBinder.new("RagdollHumanoidOnAttribute", require("RagdollHumanoidOnAttribute"), serviceBag))
